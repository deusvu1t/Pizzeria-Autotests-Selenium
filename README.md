...
- Добавлены базовые Page Object и Component Object классы, а также Page Object для страницы товара и корзины.
- Подключены логи и Allure-отчёты.
- Добавлены UI-тесты главной страницы и слайдера с пиццами, а также тесты для страницы товара.
